...
def publish(token=None, username="omesbah"):
    ...
    try:
        ...
        api.upload_folder(folder_path=".",
                          ...
                          repo_type="model",
                          ignore_patterns=[
                              ".venv/*", "__pycache__/*", ".git/*", "dist/*",
                              "data/sperner_dataset.json", "*.pyc",
    ...
    try:
        ...
        with open("DATASET_README.md", "w", encoding="utf-8") as f:
            ...
            f.write(
                "Includes ground truth labels for objective preference boundaries."
            )

        api.upload_file(path_or_fileobj="DATASET_README.md",
                        path_in_repo="README.md",
                        repo_id=dataset_id,
                        repo_type="dataset")
        api.upload_file(path_or_fileobj="data/sperner_dataset.json",
    ...
    space_id = f"{username}/sperner-demo"
    ...
    try:
        ...
        api.upload_folder(folder_path=".",
                          ...
                          ignore_patterns=[
                              ".venv/*", "__pycache__/*", ".git/*", "dist/*",
                              "data/sperner_dataset.json", "DATASET_README.md"
                          ])
