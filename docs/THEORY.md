...
The Sperner library treats the problem of multi-objective model alignment not as a scalar optimization task, but as a search for a fixed-point equilibrium within a simplicial complex.
