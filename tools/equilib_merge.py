...
logger = logging.getLogger("sperner-merge")


def main():
    parser = argparse.ArgumentParser(
        description="Sperner Merge: Automated Simplicial Adapter Merging.")
    ...
    parser.add_argument("--adapters",
                        type=str,
                        required=True,
                        help="Comma-separated LoRA adapter IDs")
    parser.add_argument("--precision",
                        type=int,
                        default=50,
                        help="Grid subdivision (resolution)")
    parser.add_argument("--output",
                        type=str,
                        default="./merged_model",
                        help="Path to save the merged weights")
    ...
    optimal_weights = merger.find_optimal_mix(evaluators,
    ...
    logger.info(
        f"Recommendation: Use these weights for Pareto-optimal deployment.")
